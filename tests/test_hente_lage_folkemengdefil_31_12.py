...
from ssb_kostra_python import (
    hente_lage_folkemengdefil_31_12,
    summere_til_aldersgrupperinger,
    hjelpefunksjoner,
    summere_kjonn,
    regionshierarki,
    validering,
    titler_til_klasskoder,
)
...
class TestHentFolkemengdeKommune3112(unittest.TestCase):
    ...
    def test_hent_folkemengde_kommune_31_12_success(
        ...
        df_base, df_final = (
            hente_lage_folkemengdefil_31_12
            .hent_folkemengde_kommune_31_12(2024)
        )
...
class TestHentFolkemengde3112Fk(unittest.TestCase):
    ...
    def test_hent_folkemengde_31_12_fk_success(
        ...
        result = (
            hente_lage_folkemengdefil_31_12
            .hent_folkemengde_31_12_fk(2024)
        )
        ...
        mock_hierarki.assert_any_call(
            df_sum_kjonn,
            aggregeringstype="kommune_til_fylkeskommune",
        )

        mock_hierarki.assert_any_call(df_fk)
